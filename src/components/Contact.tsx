    ...
    <section id="contact" className="py-16 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-zinc-400 text-sm mb-6 max-w-md mx-auto">
          Looking for an ML internship or collaboration? I&apos;m always open to discussing new
          opportunities.
        </p>
        <a
          href="mailto:jos.val.pe07@gmail.com"
          className="inline-block text-base text-white hover:text-purple-400 transition-colors font-medium"
        >
          jos.val.pe07@gmail.com
        </a>
        <div className="mt-2 text-sm text-zinc-600">
          Guanajuato, Mexico &bull; +52 (464) 167-6847
        </div>
        <div className="mt-6 flex items-center justify-center gap-5 text-sm text-zinc-600">
          <a
